...
Finally trying to catch up with the learnings. Also check out what the rest of the team put up a couple weeks ago "here":http://blog.rubinauts.com/?p=174.
...
* Using the <a href='http://github.com/mmangino/facebooker2'>Facebooker2<a/> gem you must call 'fetch' on the Facebook user to get their user details.{% highlight ruby %}
current_facebook_user.fetch
{% endhighlight %}

* Posting to a users feed is really easy with  <a href='http://github.com/mmangino/facebooker2'>Facebooker2<a/>{% highlight ruby %}
